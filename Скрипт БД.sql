Script.sql -- Adminer 4.8.1 PostgreSQL 14.5 dump
\ connect "test";
...
VALUES (1, '20', 'Москва', 'Москва', '11', 'Липовая', 1);
...
TRUNCATE "model_user";
INSERT INTO "model_user" ("id_user", "active", "password", "username")
VALUES (
        1,
        '1',
        '$2a$08$k/pcCT66sIX7yX.WIl1/aeCt72.BF5zfbp8x1PyRq28aMMw9dB74W',
        'root@gmail.com'
    ),
    (
        2,
        '1',
        '$2a$08$Izuadyyg7O2I.DoNEmR.0OHKGv0Ibx/.6ZDwkYrej1hl.ojrsX8Q2',
        'misha@gmail.com'
    );
...
VALUES (1, 'Красный', 'Помидор', 200, 1),
...
ADD CONSTRAINT "fk3flt9d2h1d916dy8c1bq7gisf" FOREIGN KEY (address_person_id) REFERENCES model_user(id_user) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."application"
ADD CONSTRAINT "fk9g4l0l14hqxmvm384fhe4pygp" FOREIGN KEY (application_person_id) REFERENCES model_user(id_user) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."order_list"
ADD CONSTRAINT "fk84ksds192y1tymsjmq1qmqro8" FOREIGN KEY (order_id) REFERENCES orders(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."order_list"
ADD CONSTRAINT "fkcj44h53c87hr23l208dyshj1n" FOREIGN KEY (product_id) REFERENCES product(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."orders"
ADD CONSTRAINT "fk72hhjqantcpqvn1ne94lu2gcm" FOREIGN KEY (address_orders_id) REFERENCES address(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."orders"
ADD CONSTRAINT "fknoettwqr56yaai4i8nwxg4huo" FOREIGN KEY (status_id) REFERENCES status(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."product"
ADD CONSTRAINT "fkrc1flv72sydvkd8819topwr4j" FOREIGN KEY (category_product_id) REFERENCES category(id) NOT DEFERRABLE;
ALTER TABLE ONLY "public"."user_role"
ADD CONSTRAINT "fkhnk3nw6rsvkly3ww7umdq7ys1" FOREIGN KEY (user_id) REFERENCES model_user(id_user) NOT DEFERRABLE;
